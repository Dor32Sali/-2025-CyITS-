...
# Update paths for package structure
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DATA_DIR = os.path.join(BASE_DIR, 'data')
MODELS_DIR = os.path.join(BASE_DIR, 'models')

# Configuration
if os.path.exists(os.path.join(DATA_DIR, 'test_camera_final.csv')):
    TEST_CAMERA_FILE = os.path.join(DATA_DIR, 'test_camera_final.csv')
    TEST_RCU_FILE = os.path.join(DATA_DIR, 'test_rcu_final.csv')
    TEST_LOOP_FILE = os.path.join(DATA_DIR, 'test_loop_final.csv')
    TEST_TYPE = "FINAL (Holdout Test)"
elif os.path.exists(os.path.join(DATA_DIR, 'extensive_tests', 'test_camera_extensive.csv')):
    TEST_CAMERA_FILE = os.path.join(DATA_DIR, 'extensive_tests', 'test_camera_extensive.csv')
    TEST_RCU_FILE = os.path.join(DATA_DIR, 'extensive_tests', 'test_rcu_extensive.csv')
    TEST_LOOP_FILE = os.path.join(DATA_DIR, 'extensive_tests', 'test_loop_extensive.csv')
    TEST_TYPE = "EXTENSIVE"
else:
    TEST_CAMERA_FILE = os.path.join(DATA_DIR, 'test_camera.csv')
    TEST_RCU_FILE = os.path.join(DATA_DIR, 'test_rcu.csv')
    TEST_LOOP_FILE = os.path.join(DATA_DIR, 'test_loop.csv')
    TEST_TYPE = "STANDARD"

MODEL_FILENAME = os.path.join(MODELS_DIR, 'isolation_forest_model.joblib')
SCALER_FILENAME = os.path.join(MODELS_DIR, 'data_scaler.joblib')
ENSEMBLE_MODEL_FILENAME = os.path.join(MODELS_DIR, 'ensemble_model.joblib')
OUTPUT_REPORT_FILE = 'advanced_test_report.txt'
